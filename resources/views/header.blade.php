        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            <form class="form-inline mr-auto">
                ...
                <div class="search-element">
                    <input class="form-control" type="search" placeholder="Ara" aria-label="Search" data-width="250">
        ...
        <div class="main-sidebar sidebar-style-2">
            <side id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index.html"><img src="assets/img/nardc.png" alt="logo" width="150" class="shadow-light "></a>
                </div>

                <ul class="sidebar-menu">
                    <li class="menu-header">Genel</li>
                    <li class="dropdown active">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Gösterge Paneli</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="index-0.html">Dosyalar</a></li>
                            <li class=active><a class="nav-link" href="{{route('welcome')}}">Depolama Verileri</a></li>
                            <li class=active><a class="nav-link" href="{{route('upload')}}">Dosya Yükle</a></li>
                        </ul>
                    </li>
                    <li class="menu-header">Dosya İşlemleri</li>
                    <li class="dropdown">
